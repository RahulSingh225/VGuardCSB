    ...
    <PaperProvider>
      <ScrollView style={styles.mainWrapper}>
        <Text style={styles.header}>
          {t('dashboard:redeem:eGiftCards:header')}
        </Text>
        <View style={styles.topHeader}>
          <TouchableOpacity
            ...
            <Text style={styles.buttonText}>
              {t('dashboard:redeem:redeemProduct:selectCategory')}
            </Text>
            <Image
          ...
          <TouchableOpacity
            ...
            <Text style={styles.buttonText}>
              {t('dashboard:redeem:redeemProduct:sortPoints')}
            </Text>
            <Image
              source={require('../../../../../assets/images/down_key.png')}
              style={{width: '10%', height: '50%'}}
        ...
        <Portal>
          <Dialog
            ...
            <Dialog.Actions>
              <Button onPress={hideCategoryDialog}>
                {t('dashboard:redeem:redeemProduct:close')}
              </Button>
            </Dialog.Actions>
          </Dialog>
        </Portal>
        <Portal>
          <Dialog visible={pointsDialogVisible} onDismiss={hidePointsDialog}>
            ...
            <Dialog.Actions>
              <Button onPress={hidePointsDialog}>
                {t('dashboard:redeem:redeemProduct:close')}
              </Button>
            </Dialog.Actions>
          </Dialog>
