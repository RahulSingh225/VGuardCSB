    ...
    <ScrollView style={styles.mainWrapper}>
      ...
      <Modal
        ...
        <View
          ...
          <Buttons
            btnStyle={{width: '50%', alignSelf: 'center',marginTop:20}}
